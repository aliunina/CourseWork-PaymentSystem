					...
					<div class="box">
						<div class="content-wrap">
							...
							<h6>
								...
								<c:if test="${errorMessage}"><fmt:message key="registration.usernotfound"></fmt:message></c:if>
							</h6>
							<form method="post">
							<label for="phone"><c:if test="${phoneError}"><fmt:message key="adduser.phoneError"></fmt:message></c:if></label>
								<input id="phone" name="phone" class="form-control" type="text"
									placeholder="${phone}*" value="${phoneValue}"> 
									<label></label>
									<input name="email"
									class="form-control" type="email" placeholder="${email}" value="${emailValue}">
									<label><c:if test="${passwordError}"><fmt:message key="registration.passwordError"></fmt:message></c:if></label>
								<input name="password" class="form-control" type="password"
									placeholder="${password}*"> 
									<label><c:if test="${passwordConfirmationError}"><fmt:message key="registration.passwordsDontMatch"></fmt:message></c:if></label>
